...
CREATE TABLE `erabiltzaile_pokemon` (
    ...
    PRIMARY KEY (`usuario_id`, `elementu_izena`),
...
('Mikel Garcia', '12345678Z', '612345678', '1990-05-15', 'mikel@test.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi'),
('Aitor Lopez', '87654321X', '698765432', '1985-08-22', 'aitor@test.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
...
('Dragonite', 'Dragoia', 91, 134, 95),
('Mewtwo', 'Psikikoa', 106, 110, 90);